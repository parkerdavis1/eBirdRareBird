...
<div
    class="dark:bg-slate-700 dark:text-slate-50 bg-slate-800 text-slate-50 text-sm"
>
    <div
    ...
    >
        ...
        <button
            ...
            on:click={() => (locationModalDisplay = !locationModalDisplay)}
        >
            <!-- globe svg -->
            <svg
                class="h-5 w-5"
        ...
        >
            ...
            <svg
                ...
                ><path
                    fill="currentColor"
                    d="M1 2.75A.75.75 0 0 1 1.75 2h8.5a.75.75 0 0 1 0 1.5h-8.5A.75.75 0 0 1 1 2.75Zm2 3A.75.75 0 0 1 3.75 5h4.5a.75.75 0 0 1 0 1.5h-4.5A.75.75 0 0 1 3 5.75ZM5.25 8a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5Z"
                /></svg
            >
    ...
    {#if locationModalDisplay}
        <div
            ...
            use:clickOutside
            on:outclick={handleLocationOutclick}
        >
            <LocationModal
    ...
    {#if showFilterModal}
        <div
            ...
            transition:fly={{ x: 200 }}
            use:clickOutside
            on:outclick={handleFilterOutclick}
        >
            <FilterModal on:close={handleFilterOutclick}></FilterModal>
        </div>
    {/if}
</div>
        ...
        {:else if filteredData}
            ...
            {:else}
                {#each groupList as groupName (groupName)}
                    <GroupName {groupedBirdData} {groupName} />
                {/each}
            {/if}
        {/if}
    </ul>
